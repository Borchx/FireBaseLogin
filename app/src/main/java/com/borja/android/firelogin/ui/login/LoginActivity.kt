package com.borja.android.firelogin.ui.login
...
import com.borja.android.firelogin.databinding.ActivityLoginBinding
import com.borja.android.firelogin.databinding.DialogPhoneLoginBinding
import com.borja.android.firelogin.ui.detail.DetailActivity
import com.borja.android.firelogin.ui.login.OathLogin.*
import com.borja.android.firelogin.ui.signup.SignUpActivity
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    showToast("Ha ocurrido un error: ${e.message}")
                }
            }
        }
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
            object : FacebookCallback<LoginResult> {
                override fun onCancel() {
                    showToast("¿Problamos con otra red social?")
                }
